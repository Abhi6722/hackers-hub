...
Checks if an element is disabled by calling [`isEnabled`](https://github.com/webdriverio/expect-webdriverio/blob/master/docs/api/element/isEnabled.html) on the element.
